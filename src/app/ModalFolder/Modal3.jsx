...
export default function Modal3({change2,set2}) {
  return (
    <div>
         <div className='bg-white fixed overflow-y-scroll h-[400px] w-[400px] shadow-[0px_0px_10px_2px_#ccc] p-3 rounded-lg z-30 bottom-[30px] left-10' >
            <span  className='fixed cursor-pointer left-[370px] hover:text-[red]' title='Cancel' onClick={()=>set2(!change2)}>Cancel</span>

            <div className='p-3 text-center'>
                <img src="https://scihospital.com/gurgaon/public/assets/images/IVF-infertility.png" alt="" className='mx-[40%] w-[100px] ' />
                <h5 className='p-3 text-[#C0333D] text-center'>IVF AND INFERTILITY
                TREATMENTS?</h5>
